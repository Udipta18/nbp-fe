                        ...
                        {providers.map((provider, index) => (
                            <Link href={`/provider/${provider.id}`} key={provider.id} className="block">
                                <motion.article
                                    ...
                                    className="group bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                                >
                                    {/* Provider Image */}
                                    <div className="aspect-[4/3] relative overflow-hidden bg-slate-100">
                                        {provider.image_url ? (
                                            <>
                                                ...
                                                />
                                                <div className="hidden w-full h-full bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center absolute inset-0">
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="pt-4 border-t border-slate-50 flex items-center justify-between">
                                            ...
                                            <Link href={`/booking/${provider.id}`} onClick={(e) => e.stopPropagation()}>
